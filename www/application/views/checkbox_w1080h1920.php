	...
	<body>
		...
		<script type='text/javascript'>
			...
			var addAnsw = function(){
				...
				var img = document.createElement('img');
				img.src = '../../images/check'+(15*document.getElementsByClassName('num').item(0).innerHTML)+'.png';
					...
					<div class="workspace">
						...
						<div class="answers">
							<div class="answer active"><input type='hidden' value=''>
								...
								<div class="elm"><img src="../../images/check30.png"></div>
			...
			<div class="right">
				<div class="control-panel">
					...
					<div class="block">
						...
						<div class="elmsize"><img src="../../images/check30.png"></div>
						<div class="number">							
							<div class="num">2</div>
		...
		<script language="javascript" type="text/javascript" src="../../js/check_size.js"/></script>
	</body>
